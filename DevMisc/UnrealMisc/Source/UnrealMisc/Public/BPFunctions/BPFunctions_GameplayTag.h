 ...
 */
UCLASS()
class UNREALMISC_API UBPFunctions_GameplayTag : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	UFUNCTION(BlueprintPure, meta = (DisplayName = "To String(FGameplayTag)", CompactNodeTitle = "->", BlueprintAutocast), Category="GameplayTag")
	static FString Conv_GameplayTagToString(FGameplayTag InTag);

	UFUNCTION(BlueprintPure, meta = (DisplayName = "To GameplayTag(String)", CompactNodeTitle = "->", BlueprintAutocast), Category="GameplayTag")
	static FGameplayTag Conv_StringToGameplayTag(const FString& TagName);

	UFUNCTION(BlueprintPure, meta = (DisplayName = "To Name(FGameplayTag)", CompactNodeTitle = "->", BlueprintAutocast), Category="GameplayTag")
	static FName Conv_GameplayTagToName(FGameplayTag InTag);

	UFUNCTION(BlueprintPure, meta = (DisplayName = "To GameplayTag(Name)", CompactNodeTitle = "->", BlueprintAutocast), Category="GameplayTag")
