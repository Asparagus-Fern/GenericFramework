...
const FInterpCurvePointVector2D UUMGSpline::DummyPointPosition(0.0f, FVector2D::ZeroVector, FVector2D::ZeroVector, FVector2D::ZeroVector, CIM_Constant);

void UUMGSpline::OnWidgetRebuilt()
{
	if (!IsDesignTime())
	{
		UpdateSpline();
...
TSharedRef<SWidget> UUMGSpline::RebuildWidget()
{
	Spline = SNew(SUMGSpline)
		.SplineInfo_UObject(this, &UUMGSpline::GetSplineInfo)
		.SplineDebugInfo_UObject(this, &UUMGSpline::GetSplineDebugInfo);

	return Spline.ToSharedRef();
}

void UUMGSpline::ReleaseSlateResources(bool bReleaseChildren)
{
...
void UUMGSpline::UpdateSpline()
{
	SplineCurves.UpdateSpline(SplineInfo);
}

FVector2D UUMGSpline::GetLocationAtSplineInputKey(float InKey, EUMGSplineCoordinateSpace::Type CoordinateSpace) const
{
...
FVector2D UUMGSpline::GetTangentAtSplineInputKey(float InKey, EUMGSplineCoordinateSpace::Type CoordinateSpace) const
{
...
FVector2D UUMGSpline::GetDirectionAtSplineInputKey(float InKey, EUMGSplineCoordinateSpace::Type CoordinateSpace) const
{
...
float UUMGSpline::GetRotationAngleAtSplineInputKey(float InKey, EUMGSplineCoordinateSpace::Type CoordinateSpace) const
{
...
float UUMGSpline::GetDistanceAlongSplineAtSplineInputKey(float InKey) const
{
...
void UUMGSpline::AddSplinePoint(const FUMGSplinePoint& SplinePoint, bool bUpdateSpline)
{
...
void UUMGSpline::AddSplinePointAtIndex(const FUMGSplinePoint& SplinePoint, int32 Index, bool bUpdateSpline)
{
...
void UUMGSpline::ChangeSplinePointAtIndex(const FUMGSplinePoint& SplinePoint, int32 Index, bool bUpdateSpline)
{
...
void UUMGSpline::RemoveSplinePoint(int32 Index, bool bUpdateSpline)
{
...
void UUMGSpline::RemoveAllSplinePoint(bool bUpdateSpline)
{
...
void UUMGSpline::SetSplineThickness(float Thickness)
{
	if (Thickness >= 0.0f)
	{
...
float UUMGSpline::GetSplineThickness() const
{
	return SplineInfo.Thickness;
}

void UUMGSpline::SetSplineMaterial(UMaterialInterface* Material)
{
...
UMaterialInterface* UUMGSpline::GetSplineMaterial() const
{
...
EUMGSplineType UUMGSpline::GetSplineType() const
{
	return SplineInfo.SplineType;
}

void UUMGSpline::SetSplineType(EUMGSplineType Type)
{
	SplineInfo.SplineType = Type;
}

int32 UUMGSpline::GetNumberOfSplinePoints() const
{
	return SplineInfo.Points.Num();
}

FVector2D UUMGSpline::GetLocationAtSplinePoint(int32 PointIndex, EUMGSplineCoordinateSpace::Type CoordinateSpace) const
{
...
FVector2D UUMGSpline::GetDirectionAtSplinePoint(int32 PointIndex, EUMGSplineCoordinateSpace::Type CoordinateSpace) const
{
	const FInterpCurvePointVector2D& Point = GetPositionPointSafe(PointIndex);
...
FVector2D UUMGSpline::GetTangentAtSplinePoint(int32 PointIndex, EUMGSplineCoordinateSpace::Type CoordinateSpace) const
{
	const FInterpCurvePointVector2D& Point = GetPositionPointSafe(PointIndex);
...
float UUMGSpline::GetSplineLength() const
{
	return SplineCurves.GetSplineLength();
}

float UUMGSpline::GetInputKeyAtDistanceAlongSpline(float Distance, EUMGSplineCoordinateSpace::Type CoordinateSpace) const
{
	const int32 NumPoints = SplineCurves.Position.Points.Num();
...
FVector2D UUMGSpline::GetLocationAtDistanceAlongSpline(float Distance, EUMGSplineCoordinateSpace::Type CoordinateSpace) const
{
	const float Param = SplineCurves.ReparamTable.Eval(Distance, 0.0f);
	return GetLocationAtSplineInputKey(Param, CoordinateSpace);
}

FVector2D UUMGSpline::GetDirectionAtDistanceAlongSpline(float Distance, EUMGSplineCoordinateSpace::Type CoordinateSpace) const
{
	const float Param = SplineCurves.ReparamTable.Eval(Distance, 0.0f);
	return GetDirectionAtSplineInputKey(Param, CoordinateSpace);
}

FVector2D UUMGSpline::GetTangentAtDistanceAlongSpline(float Distance, EUMGSplineCoordinateSpace::Type CoordinateSpace) const
{
	const float Param = SplineCurves.ReparamTable.Eval(Distance, 0.0f);
	return GetTangentAtSplineInputKey(Param, CoordinateSpace);
}

float UUMGSpline::GetRotationAngleAtDistanceAlongSpline(float Distance, EUMGSplineCoordinateSpace::Type CoordinateSpace) const
{
	const float Param = SplineCurves.ReparamTable.Eval(Distance, 0.0f);
	return GetRotationAngleAtSplineInputKey(Param, CoordinateSpace);
}

const FInterpCurvePointVector2D& UUMGSpline::GetPositionPointSafe(int32 PointIndex) const
{
