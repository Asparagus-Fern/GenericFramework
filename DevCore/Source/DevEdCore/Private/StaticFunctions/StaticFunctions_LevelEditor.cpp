...
bool FStaticFunctions_LevelEditor::CurrentEditorProjectWorldToScreen(const FVector& WorldPosition, FVector2D& ScreenPosition)
{
	return EditorProjectWorldToScreen(GCurrentLevelEditingViewportClient, WorldPosition, ScreenPosition);
}

bool FStaticFunctions_LevelEditor::EditorProjectWorldToScreen(FLevelEditorViewportClient* InLevelEditorViewportClient, const FVector& WorldPosition, FVector2D& ScreenPosition)
{
...
bool FStaticFunctions_LevelEditor::GetCurrentEditorProjectionData(FSceneViewProjectionData& ProjectionData)
{
	return GetEditorProjectionData(GCurrentLevelEditingViewportClient, ProjectionData);
}

bool FStaticFunctions_LevelEditor::GetEditorProjectionData(FLevelEditorViewportClient* InLevelEditorViewportClient, FSceneViewProjectionData& ProjectionData)
{
...
TSharedPtr<SLevelViewport> FStaticFunctions_LevelEditor::GetEditorViewportWidget(const FLevelEditorViewportClient* InLevelEditorViewportClient)
{
	if (InLevelEditorViewportClient)
	{
