...
public:
	UFUNCTION(BlueprintPure, meta = (DisplayName = "To String(FGameplayTag)", CompactNodeTitle = "->", BlueprintAutocast))
	...
	UFUNCTION(BlueprintPure, meta = (DisplayName = "To Name(FGameplayTag)", CompactNodeTitle = "->", BlueprintAutocast))
