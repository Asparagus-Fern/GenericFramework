...
DEVCORE_API DECLARE_LOG_CATEGORY_EXTERN(GenericLogProcedure, Log, All);

DEVCORE_API DECLARE_LOG_CATEGORY_EXTERN(GenericLogUI, Log, All);

DEVCORE_API DECLARE_LOG_CATEGORY_EXTERN(GenericLogCamera, Log, All);

DEVCORE_API DECLARE_LOG_CATEGORY_EXTERN(GenericLogWorld, Log, All);

DEVCORE_API DECLARE_LOG_CATEGORY_EXTERN(GenericLogProperty, Log, All);

DEVCORE_API DECLARE_LOG_CATEGORY_EXTERN(GenericLogEvent, Log, All);
