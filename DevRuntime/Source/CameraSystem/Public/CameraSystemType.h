...
struct CAMERASYSTEM_API FCameraSystemDelegates
{
	...
	DECLARE_MULTICAST_DELEGATE_OneParam(FCameraPointMulticastDelegate, ACameraPoint*)
	static FCameraPointMulticastDelegate OnCopyViewportCamera;

	/* Call When Pilot/UnPilot Camera Point */
	DECLARE_MULTICAST_DELEGATE_TwoParams(FOnCameraPointPilotStateChanged, ACameraPoint*, bool)
