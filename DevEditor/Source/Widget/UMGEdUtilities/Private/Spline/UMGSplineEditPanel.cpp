...
FText SUMGSplineEditPanel::GetPanelHeightLabel() const
{
	...
	return FText::AsNumber(UUMGEdUtilitiesSetting::Get()->PanelHeight, &Options);
}

float SUMGSplineEditPanel::GetPanelHeightSliderPosition() const
{
	return (UUMGEdUtilitiesSetting::Get()->PanelHeight - CONST_PanelHeightMin) / (CONST_PanelHeightMax - CONST_PanelHeightMin);
}
...
void SUMGSplineEditPanel::OnSetPanelHeight(float NewValue)
{
	...
	UUMGEdUtilitiesSetting::Get()->PanelHeight = DesiredHeight;
}
