...
public class gdal : ModuleRules
{
	public gdal(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		if (Target.Platform == UnrealTargetPlatform.Win64)
		{
			...
			// RuntimeDependencies.Add("$(PluginDir)/Binaries/ThirdParty/gdal/Win64/ExampleLibrary.dll");
			RuntimeDependencies.Add("$(PluginDir)/Source/ThirdParty/gdal/bin/gdal.dll");

			RuntimeDependencies.Add("$(PluginDir)/Source/ThirdParty/gdal/lib/geos_c.dll");
			RuntimeDependencies.Add("$(PluginDir)/Source/ThirdParty/gdal/lib/proj_9_2.dll");
			RuntimeDependencies.Add("$(PluginDir)/Source/ThirdParty/gdal/lib/geos.dll");
			RuntimeDependencies.Add("$(PluginDir)/Source/ThirdParty/gdal/lib/tiff.dll");
			RuntimeDependencies.Add("$(PluginDir)/Source/ThirdParty/gdal/lib/tiffxx.dll");
		}
		else if (Target.Platform == UnrealTargetPlatform.Mac)
		{
			PublicDelayLoadDLLs.Add(Path.Combine(ModuleDirectory, "Mac", "Release", "libExampleLibrary.dylib"));
			RuntimeDependencies.Add("$(PluginDir)/Source/ThirdParty/gdal/Mac/Release/libExampleLibrary.dylib");
		}
