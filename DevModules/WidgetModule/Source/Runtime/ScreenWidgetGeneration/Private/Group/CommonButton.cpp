	...
	: Super(ObjectInitializer)
{
	...
	static ConstructorHelpers::FClassFinder<UCommonButtonStyle> StyleClassFinder(TEXT("/Script/Engine.Blueprint'/WidgetModule/ButtonStyle/CBS_Transparent.CBS_Transparent_C'"));
