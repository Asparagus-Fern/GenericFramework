...
public:
	...
	PROPERTYDETAILVIEW_API virtual void ResetToDefault() PURE_VIRTUAL(,);

	/* Save The Value To Initial */
	PROPERTYDETAILVIEW_API virtual void StoreToInitial() PURE_VIRTUAL(,);

	/* Reset The Value To Initial */
	PROPERTYDETAILVIEW_API virtual void ResetToInitial() PURE_VIRTUAL(,);
};
