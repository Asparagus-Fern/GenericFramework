...
public:
	...
	UFUNCTION(BlueprintPure, meta = (DisplayName = "To Response Code Int", CompactNodeTitle = "->", BlueprintAutocast), Category="HTTP")
	static int32 BP_ConvertToResponseCodeInt(EHttpResponseCode InCode);
