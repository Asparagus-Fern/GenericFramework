...
#include "Application/VideoSettingDataSourceCollection.h"
...
void UVideoSettingDataSourceCollection::GeneratePropertyViewModels_Implementation(TArray<UPropertyViewModel*>& Result)
{
