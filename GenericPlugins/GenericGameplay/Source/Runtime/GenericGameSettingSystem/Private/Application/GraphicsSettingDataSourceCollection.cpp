...
#include "Application/GraphicsSettingDataSourceCollection.h"
...
void UGraphicsSettingDataSourceCollection::GeneratePropertyViewModels_Implementation(TArray<UPropertyViewModel*>& Result)
{
