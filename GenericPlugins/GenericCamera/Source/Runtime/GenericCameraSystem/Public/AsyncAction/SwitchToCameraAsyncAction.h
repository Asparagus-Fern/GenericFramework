...
public:
	UFUNCTION(BlueprintCallable, meta=(WorldContext = "WorldContextObject", BlueprintInternalUseOnly="true"), DisplayName="AsyncFocusToActor(Class)")
	static USwitchToCameraAsyncAction* FocusToActor_HandleClass(const UObject* WorldContextObject, APlayerController* InPlayer, AActor* InActor, float FocusLens, TSubclassOf<UGenericCameraSwitchMethod> InCameraHandleClass);

	UFUNCTION(BlueprintCallable, meta=(WorldContext = "WorldContextObject", BlueprintInternalUseOnly="true"), DisplayName="AsyncFocusToActor")
	static USwitchToCameraAsyncAction* FocusToActor_Handle(const UObject* WorldContextObject, APlayerController* InPlayer, AActor* InActor, float FocusLens, UGenericCameraSwitchMethod* InCameraSwitchMethod);
	...
	static USwitchToCameraAsyncAction* SwitchToCamera_Transform_Handle(const UObject* WorldContextObject, APlayerController* InPlayer, FVector Location, FRotator Rotation, UGenericCameraSwitchMethod* InCameraSwitchMethod);
	...
	static USwitchToCameraAsyncAction* SwitchToCamera_Actor_Handle(const UObject* WorldContextObject, APlayerController* InPlayer, ACameraActor* InCameraActor, UGenericCameraSwitchMethod* InCameraSwitchMethod);
	...
	static USwitchToCameraAsyncAction* SwitchToCamera_Component_Handle(const UObject* WorldContextObject, APlayerController* InPlayer, UCameraComponent* InCameraComponent, UGenericCameraSwitchMethod* InCameraSwitchMethod);
	...
	static USwitchToCameraAsyncAction* SwitchToCamera_Tag_Handle(const UObject* WorldContextObject, APlayerController* InPlayer, FGameplayTag InCameraTag, UGenericCameraSwitchMethod* InCameraSwitchMethod);
	...
	static USwitchToCameraAsyncAction* SwitchToCamera_CameraPoint_Handle(const UObject* WorldContextObject, APlayerController* InPlayer, ACameraPointBase* InCameraPoint, UGenericCameraSwitchMethod* InCameraSwitchMethod);
	...
	static USwitchToCameraAsyncAction* SwitchToCurrent_Handle(const UObject* WorldContextObject, APlayerController* InPlayer, UGenericCameraSwitchMethod* InCameraSwitchMethod);
	...
	static USwitchToCameraAsyncAction* SwitchToPrevious_Handle(const UObject* WorldContextObject, APlayerController* InPlayer, UGenericCameraSwitchMethod* InCameraSwitchMethod);
