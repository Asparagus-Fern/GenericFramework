...
#include "GenericButtonImageContent.generated.h"

USTRUCT(BlueprintType)
struct FButtonImageContentTableRow : public FButtonContentTableRow
{
	GENERATED_BODY()
 ...
 */
UCLASS(MinimalAPI)
class UGenericButtonImageContent : public UGenericButtonContent
{
	GENERATED_BODY()
...
protected:
	UPROPERTY()
	FButtonImageContentTableRow Cache;
};
