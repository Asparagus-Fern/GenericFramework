...
void UButtonContainer_VerticalBox::OnChildAdded_Implementation(UUserWidget* InWidget, int32 InIndex)
{
...
void UButtonContainer_VerticalBox::OnChildRemoved_Implementation(UUserWidget* InWidget, int32 InIndex)
{
