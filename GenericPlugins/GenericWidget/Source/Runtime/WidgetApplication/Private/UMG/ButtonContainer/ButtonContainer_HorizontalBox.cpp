...
#include "UMG/ButtonContainer/ButtonContainer_HorizontalBox.h"

#include "Components/HorizontalBox.h"
#include "Components/HorizontalBoxSlot.h"

void UButtonContainer_HorizontalBox::OnChildAdded_Implementation(UGenericWidget* InWidget, int32 InIndex)
{
...
void UButtonContainer_HorizontalBox::OnChildRemoved_Implementation(UGenericWidget* InWidget, int32 InIndex)
{
